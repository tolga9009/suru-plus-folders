...
Esto es extremadamente útil para restaurar el color después de cada actualización de temas de iconos (los instaladores oficiales de [Suru++ 25](https://github.com/suru-plus/suru-plus), [Suru++ Ubuntu](https://github.com/Bonandry/suru-plus-ubuntu) y algunos paquetes de terceros lo hacen automáticamente).
