...
Le fichier `suru-plus-folders` est un `script bash` qui permet de changer la couleur des dossiers chez les thèmes des icônes [Suru++ 25](https://github.com/suru-plus/suru-plus) et [Suru++ Ubuntu](https://github.com/Bonandry/suru-plus-ubuntu), basé sur des clones d'icônes de dossiers de Papirus.
