...
The file `suru-plus-folders` is a bash script that allows changing the color of folders in [Suru++ 25 icons theme](https://github.com/suru-plus/suru-plus), based on the forks of icons of folders of Papirus.
